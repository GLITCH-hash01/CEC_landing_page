...
function Accordian(){
    ...
    return(
        ...
        <div className='flex flex-col h-fit'>
            <div className='flex flex-row px-2 bg-[#5472d2] w-full h-[50px] text-white cursor-pointer' onClick={()=> setCurrentState(!isActive)}>
            ...
            {isActive && 
            <div className='h-fit w-full p-2 bg-[#647fd6] duration-300 transition-transform ease-in-ou'>
